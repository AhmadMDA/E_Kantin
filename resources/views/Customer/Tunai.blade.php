...
<link rel="stylesheet" href="{{ asset('css/csTunai.css') }}">
...
<div class="card">
    <div class="atas">Silahkan melakukan pembayaran tunai ke kantin Jurusan Teknologi Informasi!</div>
    <img src="{{ asset('/img/cc.png') }}" alt="Icon 2">
    <button class="kembali-beranda"  onclick="goToRoute('homepage')">Kembali ke beranda</button>
</div>
