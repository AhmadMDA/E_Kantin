...
<link rel="stylesheet" href="{{ asset('css/csPesanan.css') }}">
...
<div class="content">
  ...
  <div class="cardPesan">
    {{-- <form id="pesanForm" action="{{ route('Customer.kirim_pesan') }}" method="post"> --}}
      ...
      <button type="submit" class="pesan-button" onclick="goToRoute('pembayaran')">Kirim</button>
    </form>
    <span class="tulisan-pesan">Pesan :</span>
</div>
