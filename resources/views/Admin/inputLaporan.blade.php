     ...
     <div class="cardPesan">
        <div class="cardPesan">            
            ...
            <div class="textarea-container">
                ...
                <textarea id="pesanTextarea4" name="pesan4" placeholder="Masukkan nama produk"></textarea>
            </div>
                  <!-- Textarea 3 -->
            <div class="textarea-container">
                <div class="tulisan-pesan">Kategori Produk :</div>
                <textarea id="pesanTextarea1" name="pesan1" placeholder="Masukkan kategori produk"></textarea>
            </div>
            
            <!-- Textarea 4 -->
            <div class="textarea-container">
                <span class="tulisan-pesan">Harga Produk :</span>
                <textarea id="pesanTextarea4" name="pesan4" placeholder="Rp"></textarea>
            </div>
            
            <!-- Textarea 5 -->
            <div class="textarea-container">
                <span class="tulisan-pesan">Stok Awal :</span>
                <textarea id="pesanTextarea4" name="pesan4" placeholder="pcs"></textarea>
            </div>
            <!-- Textarea 6 -->
            <div class="textarea-container">
              <div class="tulisan-pesan">Terjual :</div>
              <textarea id="pesanTextarea1" name="pesan1" placeholder="pcs"></textarea>
          </div>
